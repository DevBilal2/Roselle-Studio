      ...
      <div className="container mx-auto px-4">
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="relative overflow-hidden rounded-3xl shadow-xl">
                    ...
                    <div className="p-8 md:p-14 flex flex-col md:flex-row items-center">
                      ...
                      <div className="flex-1 md:pr-8">
                        ...
                        <div className="mt-8 flex flex-col sm:flex-row gap-4">
                          ...
                          <button className="px-6 py-4 bg-white/90 border-2 border-stone-300 text-stone-900 rounded-lg hover:bg-white transition shadow-lg">
                            Learn More
                          </button>
                        </div>
            ...
            <button
              onClick={prev}
              className="absolute left-0 top-1/2 -translate-y-1/2 bg-white/90 backdrop-blur-sm p-3 rounded-full shadow-xl hover:scale-110 transition border border-stone-200"
            >
              <ChevronLeft className="text-stone-900" size={24} />
            </button>

            <button
              onClick={next}
              className="absolute right-0 top-1/2 -translate-y-1/2 bg-white/90 backdrop-blur-sm p-3 rounded-full shadow-xl hover:scale-110 transition border border-stone-200"
            >
              <ChevronRight className="text-stone-900" size={24} />
            </button>
          </div>
